...
namespace UKnowledge.Web.Migrations
{
    ...
    [Migration("20201103131021_domain_completed")]
    partial class domain_completed
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UKnowledge.Web.Models.AuthenticationModels.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("UKnowledge.Web.Models.AuthenticationModels.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UKnowledge.Web.Models.Favorite", b =>
                {
                    ...
                    b.HasOne("UKnowledge.Web.Models.AuthenticationModels.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
