...
namespace UKnowledge.Web.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(UKnowledgeDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Title,Description,TutorName,Id,CreatedDate,UpdatedDate,IsDelete")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(double id, [Bind("Title,Description,TutorName,Id,CreatedDate,UpdatedDate,IsDelete")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
        ...
        private bool CourseExists(double id)
        {
